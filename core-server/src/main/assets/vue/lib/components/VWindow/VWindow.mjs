import { withDirectives as _withDirectives, resolveDirective as _resolveDirective, createVNode as _createVNode } from "/js/vue.js";
// Styles
import "./VWindow.css";
...
import { computed, provide, ref, shallowRef, watch } from "/js/vue.js";
