...
object FileUtil {
    ...
    fun getFileType(extension: String?, mime: String): FileType {
        return when {
            mime.startsWith(FileType.Image.type) -> FileType.Image
            mime.startsWith(FileType.Video.type) -> FileType.Video
            mime.startsWith(FileType.Audio.type) -> FileType.Audio
            extension.equals("apk", true) -> FileType.App
